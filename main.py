  ...
  for x in markers:
    ...
    for y in x:
      if y == 1:
        ...
        pygame.draw.line(screen, white, (x_pos * 100 + 15, y_pos * 100 + 85),
...
def check_winner():
  ...
  #check cross
  if markers[0][0] + markers[1][1] + markers[2][2] == 3 or markers[2][
      0] + markers[1][1] + markers[0][2] == 3:
    winner = 1
    game_over = True
  if markers[0][0] + markers[1][1] + markers[2][2] == -3 or markers[2][
      0] + markers[1][1] + markers[0][2] == -3:
...
while run:
  ...
  if game_over is True:
    draw_winner(winner)
    #checl for mouseclick to see if user has clicked on Play Again
    if event.type == pygame.MOUSEBUTTONDOWN and clicked is False:
      clicked = True
    if event.type == pygame.MOUSEBUTTONUP and clicked is True:
      clicked = False
